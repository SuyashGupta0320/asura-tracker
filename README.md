...
A Chrome extension for tracking manga reading progress on AsuraComic.net. It automatically logs which chapter you're on, checks for new releases in the background, and can navigate you to the next chapter automatically when you finish one. Available on the Chrome Web Store.
